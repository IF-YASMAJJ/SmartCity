...
namespace ServeurSmartCity.Models
{
    public static class DonneesGeographiques
    {
        ...
        public static float distance(float long1, float long2, float lat1, float lat2)
        {
            ...
            // Calcul indépendant sur les axes de latitudes et longitude, puis utilisation du théorème de Pythagore pour la distance finale.
        ...
        public static float distanceTest(float long2, float lat2)
        {
            return distance(minLong, long2, minLat, lat2);
        }
    }
}